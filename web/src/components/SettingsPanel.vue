...
import {BasePanel, BaseToggle, BaseSlider, ButtonGroup, BaseAlert, BaseInfoIcon, BaseProLock} from './ui'
import {
      ...
      if (newSettings) {
        localSettings.value = {
          ...
          background_extraction_algorithm:
              newSettings.background_extraction_algorithm ?? DEFAULT_SETTINGS.background_extraction_algorithm,
          ...
          saturation_boost_strength: newSettings.saturation_boost_strength ?? DEFAULT_SETTINGS.saturation_boost_strength,
          simulated_camera: newSettings.simulated_camera ?? DEFAULT_SETTINGS.simulated_camera,
          simulated_preload_images: newSettings.simulated_preload_images ?? DEFAULT_SETTINGS.simulated_preload_images,
          eyepiece: newSettings.eyepiece ? {...newSettings.eyepiece} : {...DEFAULT_SETTINGS.eyepiece},
        }
      }
    },
    {immediate: true}
  ...
  <BasePanel title="Settings">
    ...
    <div class="settings-section">
      ...
      <BaseSlider
          ...
          @change="debouncedApply('saturation_boost_strength', localSettings.saturation_boost_strength)"
      >
        <template #label-extra>
          <BaseProLock v-if="!capabilities.deep_sky.saturation_boost" feature="Saturation Boost"/>
        </template>
    ...
    <div v-if="localSettings.stacking" class="settings-section">
      ...
      <div class="control-group">
        <div class="control-row">
          <label class="control-label" style="margin-bottom: 0; flex: 1">
            Rejection Method
            <BaseProLock v-if="!capabilities.deep_sky.advanced_rejection" feature="Advanced Rejection"/>
    ...
    <div class="settings-section">
      ...
      <div v-if="simulatorEnabled" class="control-group" style="margin-top: 0.5rem">
        <BaseSlider
            ...
            @change="debouncedApply('simulated_preload_images', localSettings.simulated_preload_images)"
        />
      </div>
    </div>
  </BasePanel>
