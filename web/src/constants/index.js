...
export const HELP_TEXTS = {
    ...
    auto_stretch: "Automatically applies transformation to make faint details visible to the human eye.",
    stretch_aggressiveness: "Controls how strongly the dark areas are boosted. High is best for extremely faint nebulae, Low preserves star colors and contrast.",
    background_subtraction: "Removes gradients caused by light pollution or moonlight, resulting in a more even background across the image.",
    background_extraction_algorithm: "Choose the background removal algorithm:\n• Grid (Fast): Grid-based interpolation. Fast and stable for general EAA.\n• RBF (High Quality): Radial Basis Function. Intelligently routes around nebulae to protect faint signals.",
    saturation_boost: "Intensifies colors in the darkest parts of the image, helping faint nebulae and galaxy arms 'pop' without over-saturating stars.",
    saturation_boost_strength: "Adjusts the intensity of the Shadow Saturation Boost. Higher values create more vibrant colors in faint areas.",
    save_raw_frames: "Saves individual captured frames as FITS files to 'captures/raw/'. Only works in Stacking mode.",
    save_stacked_image: "Saves the final stack as a FITS and a stretched PNG to 'captures/stacked/'. Only works in Stacking mode.",
    weighting_preset: "Determines how much each frame contributes based on quality:\n• Disabled: All frames weighted equally.\n• Balanced: General purpose blending.\n• Galaxies: Favors sharpest frames (FWHM).\n• Nebulae: Favors highest signal (SNR).\n• FWHM Only: Ignores SNR, prioritizes sharpness.\n• SNR Only: Ignores sharpness, prioritizes signal.\nChanges apply immediately to subsequent frames.",
    simulated_camera: "Uses images from a directory instead of a real camera.",
    simulated_preload_count: "Number of images to keep in memory for the simulator. Higher values make playback smoother but use more RAM.",
    stacking: "Determines how the camera feed is processed:\n• Live view: Raw feed, no stacking. Best for focusing.\n• Wanderer: Auto-stacks when stationary, resets on movement.\n• Stacking: Continuous real-time image accumulation.",
    stacking_type: "Specifies the processing pipeline:\n• Deep Sky: Optimized for long exposures of nebulae and galaxies.\n• Planetary: High-speed imaging for planets/Moon.\n• Comet: Special alignment that tracks the comet's motion",
    exposure: "Controls how long the camera sensor collects light for each frame. Longer exposures reveal fainter details but are more sensitive to tracking errors.",
    gain: "Electronic amplification of the signal. Higher gain increases sensitivity but also introduces more read noise.",
    wanderer_mode: "Automatically resets the stack when you move to a new target. Once stationary, stacking restarts and the live stack is displayed.",
    eyepiece_binoview: "Splits the screen into two independent copies of the image based on physical screen dimensions and resolution.",
